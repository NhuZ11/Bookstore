  ...
  return (
    <SidebarProvider >
      ...
      <SidebarInset>
        ...
        <div className="m-10 ">
          <Card className="size-80 w-auto bg-[#EDE0D4]">
          ...
          <div className="flex justify-end gap-40">
            ...
            <CardContent>
                <p >Engage your shop books with this Dashboard
                  <br></br>and make salses everyday to your shop
                </p>
              </CardContent>
            <Image 
            src="/We Heart It.jpg"  
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogTrigger asChild>
          <Button className="mb-6 bg-[#8B5E3C] text-white hover:bg-[#6D4C41]">Add a Book</Button>
        </DialogTrigger>
