    ...
    <SidebarProvider>
      <div className="flex h-screen overflow-hidden">
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
          ...
          <SidebarInset>
            <header className="flex h-16 items-center gap-2 border-b px-4 bg-[#c0b5b8]">
              ...
              <Card className="flex-start size-auto w-auto bg-[#EDE0D4]">
                <CardHeader className="flex flex-col items-center">
                  <div className="flex gap-40">
                    <CardTitle className="italic text-6xl">Upload Your Books <br /> To Increase Your Sales</CardTitle>
                    <CardContent>
                      <p className="text-2xl">Engage your shop books with this Dashboard <br /> and make sales every day to your shop</p>
                    </CardContent>
                ...
                <CardFooter>
                  <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    <DialogTrigger asChild>
                      <Button className="w-36 h-14 mb-6 bg-[#8B5E3C] text-white hover:bg-[#6D4C41] text-2xl" disabled={loading}>
